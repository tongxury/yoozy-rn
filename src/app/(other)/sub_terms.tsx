...
// yoozy.ai 付费服务协议（含自动续费服务规则）
// 使用 NativeWind (Tailwind CSS for React Native) 进行样式设置

export default function SubTerms() {
    return (
        <ScreenContainer stackScreenProps={{ headerShown: true, title: "yoozy.ai 付费服务协议" }}>
            <ScrollView contentContainerClassName="px-4 py-6">
                ...
                <Text className=" text-sm leading-relaxed mb-3">
                    公司对《yoozy.ai 付费服务协议》进行了更新，本次更新重点内容提示如下：
                </Text>
                <Text className=" text-sm leading-relaxed mb-3">
                    （1）明确一般会员权益包括每月赠送积分；
                </Text>
                <Text className=" text-sm leading-relaxed mb-3">
                    （2）明确用户可在苹果设备客户端的“游客模式”下购买yoozy.ai付费服务；
                </Text>
                <Text className=" text-sm leading-relaxed mb-3">
                ...
                <Text className=" text-sm leading-relaxed mb-3">
                    欢迎您使用yoozy.ai付费服务，请您仔细阅读、理解并遵守如下协议。
                </Text>

                <Text className=" text-lg font-bold mt-5 mb-3">一、导言</Text>
                <Text className=" text-sm leading-relaxed mb-3">
                    1.1 yoozy.ai付费服务（以下简称“本服务”或“付费服务”）由 yoozy.ai Team
                    及/或其关联方（以下简称“公司”或“我们”）为您（或称“用户”）提供，就您使用yoozy.ai付费服务相关事宜与您达成《yoozy.ai付费服务协议》，简称为“本协议”，本协议含附录《自动续费服务规则》。
                </Text>
                <Text className=" text-sm leading-relaxed mb-3">
                    1.2
                ...
                <Text className=" text-sm leading-relaxed mb-3">
                    2.1 本协议适用于您在使用yoozy.ai过程中需以付费方式开通的各项服务，目前本协议覆盖系列会员服务、积分服务，您开通及使用以上任一项付费服务，均适用本协议。请您了解，以上所列各项付费服务属于不同的付费产品功能，您开通其中任一付费服务并不意味着您当然的可以同时获得其他单项付费服务的使用资格，请您根据实际需求前往对应的产品功能页面开通对应的付费服务。
                </Text>
                <Text className=" text-sm leading-relaxed mb-3">
                    2.2 请您了解，您在开通或使用付费服务时，本协议为《yoozy.ai用户服务协议》《yoozy.ai隐私政策》的补充协议，是其不可分割的组成部分，与其构成统一整体。本协议与上述内容存在冲突或不一致的，以本协议为准。
                </Text>

                <Text className=" text-lg font-bold mt-5 mb-3">三、名词定义</Text>
                <Text className=" text-sm leading-relaxed mb-3">
                    3.1 “yoozy.ai”/“平台”：指公司合法拥有并运营的、标注名称为“yoozy.ai”的客户端应用程序、官方网站（yoozy.aiapp.com）以及供第三方网站和应用程序使用的软件开发工具包（SDK）和应用程序编程接口（API）。公司有权根据业务发展、安排随时调整向您提供的具体yoozy.ai平台版本，请以您实际使用的版本为准。
                </Text>
                <Text className=" text-sm leading-relaxed mb-3">
                    3.2 “用户”：指登录、注册、使用yoozy.ai并拟开通或购买付费服务的yoozy.ai付费用户；在本协议中，该“用户”即指“您”。
                </Text>
                <Text className=" text-sm leading-relaxed mb-3">
                    3.3 “用户账号”：指用户用于开通付费服务的yoozy.ai账号。
                </Text>
                <Text className=" text-sm leading-relaxed mb-3">
                    3.4 “会员账号”：指与您的会员服务绑定的用户账号。
                </Text>
                <Text className=" text-sm leading-relaxed mb-3">
                    3.5 “普通账号”：指并非会员账号的yoozy.ai用户账号。
                </Text>
                <Text className=" text-sm leading-relaxed mb-3">
                    3.6 “积分”：指公司依据相关平台规则向用户提供的用于在yoozy.ai平台进行相关消费（如兑换特定yoozy.ai平台功能）的虚拟工具。兑换yoozy.ai平台内具体功能、模型和服务所需要的积分数可能不同，以届时yoozy.ai平台相关产品、服务页面的提示说明为准。您可在登录yoozy.ai后通过以下路径查阅积分余额及相关积分获取规则：yoozy.ai移动端【我的】-【会员中心】-【我的积分】；yoozy.ai网站【积分/会员】-【积分详情】。
                </Text>
                <Text className=" text-sm leading-relaxed mb-3">
                ...
                <Text className=" text-sm leading-relaxed mb-3">
                    3.9 “平台规则”：指本协议、《yoozy.ai用户服务协议》《yoozy.ai隐私政策》，及公司已经或在未来不时发布的yoozy.ai相关服务、某一/多项付费服务的协议、规则、公告、附加条款、产品要求、购买须知、站内信通知等协议和内容的统称。
                </Text>

                <Text className=" text-lg font-bold mt-5 mb-3">四、付费服务说明及规则</Text>
                <Text className=" text-base font-bold mt-4 mb-2">4.1 系列会员服务</Text>
                <Text className=" text-sm leading-relaxed mb-3">yoozy.ai会员类别包括：基础会员、标准会员和高级会员（合称为“会员”），该三类会员在权益及服务方面存在差异，请您根据需求选择开通相关会员服务。公司有权根据实际需要不时调整会员类别、名称、权益等，并将以适当的方式通知您。</Text>
                ...
                <Text className=" text-sm leading-relaxed mb-3">
                    （2）请您了解，您所订阅的任一会员服务需要您登录您的会员账号方可使用。会员账号的管理及安全请您参照《yoozy.ai用户服务协议》项下关于“账号”的条款约定。
                </Text>
                <Text className=" text-sm leading-relaxed mb-3">
                ...
                <Text className=" text-sm leading-relaxed mb-3">
                    （6）您开通会员服务后，您可登录会员账号查询您的付费权益信息（如已开通权限、使用期限等），查询路径为：yoozy.ai网站【积分/会员】；yoozy.ai移动端【我】-【设置】-【订阅和发票】/【会员中心】。
                </Text>

                <Text className=" text-base font-bold mt-4 mb-2">4.2 积分服务</Text>
                <Text className=" text-sm leading-relaxed mb-3">
                    4.2.1 “积分”是我们向您提供的用于在yoozy.ai平台上进行相关消费的虚拟工具，您可以使用积分兑换包括但不限于“图片生成”、“视频生成”和“数字人”等yoozy.ai平台功能（具体功能服务详情及其对应的积分兑换数量等请查看yoozy.ai平台相关产品、服务页面的提示说明）。您了解并确认，积分充值成功后将不支持退款或反向兑换为人民币及其他货币，积分只能兑换本协议约定的yoozy.ai平台功能或服务。
                </Text>
                <Text className=" text-sm leading-relaxed mb-3">
                    4.2.2 您理解并确认，积分的使用期限根据积分类型不同存在差异，具体如下：
                </Text>
                <Text className=" text-sm leading-relaxed mb-3">
                    （1）系列会员权益项下赠送的积分（订阅积分）：在系列会员（包括连续包月及连续包年的系列会员）使用期限内以月为周期赠送积分，积分的使用期限为用户获取积分之日起1个月内，即从用户的会员账号获取yoozy.ai平台赠送的积分之时开始，至1个自然月结束后的当日截止（例如，用户订阅连续包年的系列会员服务，在2025年1月1日10:00订阅成功并获取yoozy.ai平台赠送的积分之时，积分的使用期限开始，并在2025年2月1日10:00截止）。
                </Text>
                <Text className=" text-sm leading-relaxed mb-3">
                    （2）yoozy.ai平台每日赠送的积分（赠送积分）：积分的使用期限为当日，从用户登录账号并获取yoozy.ai平台赠送的积分之时开始，当日截止（例如，用户在2025年1月1日10:00登录并获取yoozy.ai平台赠送的积分之时，积分的使用期限开始，并在2025年1月1日23时59分59秒截止）。
                </Text>
                <Text className=" text-sm leading-relaxed mb-3">
                    （3）用户充值积分（充值积分）：积分的使用期限为2年，从用户充值成功之时开始，至2个自然年结束后的当日截止（例如，用户2025年1月1日10:00充值成功，用户账号内的积分有效期从用户充值成功时开始，2027年1月1日10:00截止）。
                </Text>
                <Text className=" text-sm leading-relaxed mb-3">
                    您可在yoozy.ai移动端【我】-【设置】-【会员中心】-【我的积分】、yoozy.ai网站【积分/会员】-【积分详情】中查看积分的余额情况、积分获得和消耗记录，该等记录将作为您使用积分情况的有效依据。如您对积分记录有异议，您可以通过本协议约定的联系方式与公司联系，我们调查核对后确有错误的，将予以更正。
                </Text>
                <Text className=" text-sm leading-relaxed mb-3">
                ...
                <Text className=" text-sm leading-relaxed mb-3">
                    5.1.1 yoozy.ai以AI技术为驱动，平台投入大量成本提升技术能力，用以更新迭代与优化为您提供的产品功能和服务。
                </Text>
                <Text className=" text-sm leading-relaxed mb-3">
                    5.1.2 请您了解，具体每项付费服务项下权益及内容的收费标准、积分兑换数量应以实际购买时或积分兑换时yoozy.ai平台相关产品、服务页面中所展示的标价或提示说明为准。
                </Text>
                <Text className=" text-sm leading-relaxed mb-3">
                    5.1.3 请您了解，公司对yoozy.ai平台提供的付费服务及其项下对应包含的用户权益享有自主定价的权利。
                </Text>
                <Text className=" text-sm leading-relaxed mb-3">
                ...
                <Text className=" text-sm leading-relaxed mb-3">
                    5.2.1 请您注意，除本协议另有约定外，本协议项下付费服务的开通或购买均需在用户账号登录后操作，如您不使用用户账号进行登录，您将以“游客模式”使用yoozy.ai部分服务或功能的体验，但将无法开通、购买付费服务。
                </Text>
                <Text className=" text-sm leading-relaxed mb-3">
                    5.2.2 yoozy.ai移动端目前提供多种登录方式。特别提示您，如您需将所购买的单项付费服务及相关功能、权益在yoozy.ai平台各端口实现互通使用，您需使用同一账号登录。
                </Text>
                <Text className=" text-sm leading-relaxed mb-3">
                    5.2.3 您应该通过yoozy.ai平台指定的现有支付方式或今后yoozy.ai指定的支付方式支付购买费用。不同终端和系统可支持的支付方式可能不同，请根据支付页面的指示完成支付。
                </Text>

                <Text className=" text-base font-bold mt-4 mb-2">5.3 游客模式</Text>
                <Text className=" text-sm leading-relaxed mb-3">
                    5.3.1 苹果应用商店（App Store）渠道允许非注册用户在“游客模式”下购买yoozy.ai付费服务，即对应的付费权益将会绑定您购买付费服务时所用的苹果设备，且该等付费权益也将仅可在绑定设备上使用；但请您了解，您的付费权益可能会因为您使用游客模式而无法完整享受。公司提示您注意，若您绑定付费权益的苹果设备丢失、损坏，或您对其进行系统升级、还原、清空或其他类似行为的，将会导致您无法继续使用绑定于此设备的付费权益，由此造成的您的损失，您应当自行承担。
                </Text>
                <Text className=" text-sm leading-relaxed mb-3">
                    5.3.2 公司在此建议，您在购买付费服务前，按照yoozy.ai前端页面操作指引登录您的用户账号，以便于您在其他您所持有的设备上使用所购买的各项付费权益，以及更好、更安全地享受我们为您提供的付费服务。
                </Text>

                <Text className=" text-base font-bold mt-4 mb-2">5.4 退费规则</Text>
                <Text className=" text-sm leading-relaxed mb-3">
                    由于yoozy.ai付费服务及权益为虚拟消费商品，除因法定情形、本协议约定情形或因yoozy.ai服务及功能存在重大瑕疵导致您无法正常使用所购服务、权益等公司违约情形外，您在完成相应购买和支付行为后，原则上不可进行转让或要求退费，请您在购买相应付费服务（包括自动续费服务）之前，仔细核对服务及权益信息、价格、使用期限及本协议相关使用规则，并注意仔细核实您购买服务的用户账号信息。
                </Text>
                ...
                <Text className=" text-sm leading-relaxed mb-3">
                    6.2 请您注意，各项付费服务及相应付费权益仅限您本人通过您注册的用户账号使用。未经公司书面同意，禁止以任何形式赠与、借用、出租、转让、售卖或以其他方式许可他人使用该用户账号及账号内已购服务、权益。如果公司发现或者有合理理由认为实际使用者并非用户账号所有人，为保障用户账号及用户权益安全，公司有权立即暂停或终止向该用户账号提供相应服务或权益。您应正确使用及妥善保管、维护您的用户账号及密码，如非因yoozy.ai平台及公司过错而发生的泄露、遗失、被盗等情况，您需自行承担相应损失。
                </Text>
                <Text className=" text-sm leading-relaxed mb-3">
                ...
                <Text className=" text-sm leading-relaxed mb-3">
                    6.6 请您了解，我们尊重并保护用户、创作者及他人的知识产权、肖像权、名誉权、隐私权等合法权益。您需保证，在使用yoozy.ai平台功能及各项服务时，如相关服务、功能支持您上传文字、图片、视频、音频或素材等内容的，您需确保您所上传的内容不侵犯任何第三方的知识产权、肖像权、名誉权、隐私权等权利及合法权益。如您违反该要求，相关侵权责任需由您自行承担，且我们有权在收到并按照相关平台规则核实相关权利方投诉的情况下，自主决定移除该等侵权内容，您需自行承担因此给您造成的损失或不利后果，且因此给公司造成损失的，公司有权向您追偿，并有权视情况按照第8.2条采取相关处理措施。
                </Text>
                <Text className=" text-sm leading-relaxed mb-3">
                ...
                <Text className=" text-sm leading-relaxed mb-3">
                    7.2 中止或终止相应付费服务后，公司有权利但无义务确保您收到特别提示或通知，当您发现无法正常使用服务时，可以与yoozy.ai平台客服联系。
                </Text>
                <Text className=" text-sm leading-relaxed mb-3">
                ...
                <Text className=" text-sm leading-relaxed mb-3">
                    8.1 您理解并同意，因您自身违反法律、法规，违反本协议或相关平台规则的规定，导致或产生第三方主张的任何索赔、要求或损失，您需独立承担责任，如因此给公司或yoozy.ai造成损失的，您需承担赔偿责任。
                </Text>
                <Text className=" text-sm leading-relaxed mb-3">
                ...
                <Text className=" text-sm leading-relaxed mb-3">
                    9.1 公司是yoozy.ai（包括yoozy.ai整体及yoozy.ai涉及的所有内容、组成部分或构成要素，本段下同）的知识产权权利人，享有yoozy.ai的一切著作权、商标权、专利权、商业秘密等知识产权及其他合法权益，以及与yoozy.ai相关的所有信息内容（包括但不限于相关文字、图片、音频、视频、图表、产品页面设计、版面框架、有关数据或电子文档等）的知识产权和合法权益，但相关权利人依照法律规定应享有的权利除外。除本协议另有约定外，未经公司事先书面同意，您不得以任何方式将yoozy.ai平台功能、服务及前述yoozy.ai拥有知识产权的内容以商业用途进行使用，不得对yoozy.ai进行包括（但不限于）反向工程、反编译、反汇编等可能影响或改变其原有内容或功能的行为，不得破解或试图破解yoozy.ai的安全和保密措施，不得对yoozy.ai的资源进行爬取、存储、缓存、下载、镜像等，且不得利用yoozy.ai开发同类产品、服务，也不得协助或允许任何第三方进行上述行为，否则由此给公司及/或其他权利人造成的损失均应由您承担全部责任。
                </Text>
                <Text className=" text-sm leading-relaxed mb-3">
                    9.2 在yoozy.ai付费服务下，公司是在该付费服务中向用户提供的AI模型等权益内容（本条简称“公司提供内容”）的知识产权权利人，自行享有或者经授权享有前述内容的一切知识产权及其他合法权益。除公司作为权益提供方外，其他灵感模板、素材等内容由创作者提供（本条简称“创作者提供内容”），创作者享有创作者提供内容的一切知识产权及合法权益。除按照相关平台规则使用外，您无权对上述公司提供内容及创作者提供内容进行其他超出使用规则范围的使用或处分，否则由此给公司及/或创作者造成的损失均应由您承担全部责任。
                </Text>
                <Text className=" text-sm leading-relaxed mb-3">
                ...
                <Text className=" text-sm leading-relaxed mb-3">
                    9.4 为持续改善yoozy.ai为您提供的各项服务，您理解并同意，对于您使用yoozy.ai平台的输入内容、yoozy.ai平台接收相应您的输入内容而生成图片、音视频、文字等生成内容及您发布的信息内容，您授予我们一项全球范围内、免费、非独家、可多层次再许可的权利，允许我们用于根据平台规则向您提供服务、优化我们的产品服务及模型以及确保服务的安全性和稳定性。如果您不希望我们用于前述目的，您可通过意见反馈相关页面或发送邮件至 support@yoozy.aiapp.com 联系我们。
                </Text>
                ...
                <Text className=" text-sm leading-relaxed mb-3">
                    但公司愿意并欢迎您对yoozy.ai、付费服务及相关用户权益的提升和改进提出您的宝贵意见，公司将对您的合理意见充分考虑，并不断优化平台功能及服务。
                </Text>

                <Text className=" text-lg font-bold mt-5 mb-3">十一、 投诉与联系方式</Text>
                <Text className=" text-sm leading-relaxed mb-3">
                    11.1 如您对本协议、付费服务及用户权益有任何疑问、投诉、意见和建议等，请前往yoozy.ai移动端【我】-【设置】-【帮助与反馈】进行意见反馈，或通过 support@yoozy.aiapp.com 联系我们，我们会及时响应和处理。
                </Text>
                <Text className=" text-sm leading-relaxed mb-3">
                ...
                <Text className=" text-sm leading-relaxed mb-3">
                    12.1 yoozy.ai的主要适用人群是成年人，若您是未满18周岁的未成年人，您应在监护人指导下认真阅读本协议，经您的监护人同意本协议后，方可使用相应付费服务。若您未取得监护人的同意，监护人可以通过yoozy.ai公示渠道或本协议约定的联系方式通知公司处理相关账号，公司有权对相关用户账号的功能（包括但不限于浏览、使用、消费等）进行限制。
                </Text>
                <Text className=" text-sm leading-relaxed mb-3">
                ...
                <Text className=" text-sm leading-relaxed mb-3">
                    本《自动续费服务规则》（以下简称“本规则”）被视为《yoozy.ai付费服务协议》的补充协议，是其不可分割的组成部分，与其构成统一整体。如本规则与《yoozy.ai付费服务协议》存在冲突，则以本规则为准。 您在购买付费服务时，如确认选择“连续订阅”（例如“连续包月”“连续包年”等，以相应付费服务购买页面展示为准）并通过点击同意《yoozy.ai付费服务协议》、支付费用等确认行为进行下一步操作或使用付费服务，则视为您同意本规则。
                </Text>
                <Text className=" text-sm leading-relaxed mb-3">
                    您理解并同意：
                </Text>
                ...
                <Text className=" text-sm leading-relaxed mb-3">
                    ...
                    点击“订阅”--&gt;选择yoozy.ai相关拟取消自动续费的付费服务名称，取消订阅。
                </Text>
                <Text className=" text-sm leading-relaxed mb-3">
                    （2）yoozy.ai平台网站和安卓用户：
                </Text>
                <Text className=" text-sm leading-relaxed mb-3 pl-4">
                    i. 以支付宝支付： 打开“支付宝”App ，点击“我的”右上角设置，选择“支付设置”-“免密支付/自动扣款”，选择yoozy.ai相关自动续费的付费服务进行解约操作；
                </Text>
                <Text className=" text-sm leading-relaxed mb-3 pl-4">
                    ii. 以微信支付： 打开“微信”App，点击“我”-“服务”-“钱包”，点击页面下方“支付设置”-“自动续费”，选择yoozy.ai相关自动续费的付费服务进行解约操作；
                </Text>
                <Text className=" text-sm leading-relaxed mb-3 pl-4">
                    iii. 通过抖音支付：打开“抖音”App，点击我-右上角“我的钱包”-“抖音支付”-“设置”-“自动扣款管理”，选择yoozy.ai相关自动续费的付费服务进行解约操作 。
                </Text>
                <Text className=" text-sm leading-relaxed mb-3">
                    除上述退订方式外，您也可以通过yoozy.ai移动端【我】-【设置】-【订阅和发票】、yoozy.ai网站【积分/会员】-【订阅管理】页面中的“自动续费”模块进行取消续费操作。
                </Text>
                <Text className=" text-sm leading-relaxed mb-3">
